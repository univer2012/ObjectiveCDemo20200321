...
//
/*
 demo来自：[iOS使用Charts框架绘制折线图](https://www.jianshu.com/p/039d6d9ff3f7)
 
 https://github.com/cCathyc/ChartsDemo
 */
...
@interface SGHLineChartViewController ()<ChartViewDelegate>
@property (nonatomic,strong) LineChartView * lineView;
@property (nonatomic,strong) UILabel * markY;

@end

@implementation SGHLineChartViewController
...
- (LineChartData *)setData{
    ...
    if (_lineView.data.dataSetCount > 0) {
        ...
        LineChartDataSet *set2 = [[LineChartDataSet alloc]initWithEntries:yVals2 label:nil];
        //[set1 copy];
        //set2.entries = yVals2;
